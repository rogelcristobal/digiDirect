  ...
  const content = (
    <>
      ...
      <Box className="box-border space-y-12">
        <TextContent
          anchor="inTheBox"
          sx="text-blue-400 text-[1.35rem] leading-[1.85rem]  "
      ...
      {/*  seo */}
      <div data-scroll="seo" className="box-border space-y-16">
        <TextContent
          anchor="metaTitle"
          sx="text-xl text-blue-400 "
          title="Meta title"
  ...
  return (
    <Box className="min-h-[150vh] h-full inline-block box-border" ref={myRef}>
      <Box className="  h-auto box-border    w-full flex items-start justify-center gap-3 ">
        {/* side nav */}
        <Box className="box-border h-[90vh]  w-80 sticky top-4 flex mt-3 flex-col justify-start items-start p-3 space-y-3 thin-right-divider">
          <Box
        ...
        <Box className=" w-full box-border h-full space-y-4 p-3 pb-40 pt-16">
          ...
          <Box className="box-border  flex flex-col items-start justify-start">
            <ArticleBlock title="Product listing templates">{content}</ArticleBlock>
          </Box>
        </Box>
      </Box>
