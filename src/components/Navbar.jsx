...
const Navbar = () => {
  ...
  return (
    <Box className={`h-[4.3rem] fixed ${state >= 100? 'bg-[#ffffff] navBorder ':'bg-transparent'} trnsition-all duration-300 ease-in-out px-4 z-10 w-full top-0  left-0 box-border flex items-end justify-end `}>
