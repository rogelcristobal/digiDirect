...
export const Acard = () => {
	return (
		<div className="h-full w-full flex flex-col items-start justify-end box-border  relative text-gray-400 hover:text-gray-300  duration-300 transition-all ease-in-out space-y-2">
			<div className="p-2 box-border rounded-lg bg-[#050c12]/80 absolute -top-1 -right-1 text-gray-500 hover:text-gray-300 ">
				<BiDotsHorizontalRounded></BiDotsHorizontalRounded>
			</div>
			<div className="flex items-center justify-start space-x-4  w-full ">
				<div className="p-3 rounded-xl  bg-[#050c12]/80">
					<BiBookContent className="text-xl"></BiBookContent>
				</div>
...
export const Bcard = () => {
	return (
		<div className="h-full w-full flex flex-col items-start justify-end box-border  relative text-gray-400 hover:text-gray-300  duration-300 transition-all ease-in-out space-y-2">
			...
			<div className="flex items-center justify-start space-x-4  w-full ">
				<div className="p-3 rounded-xl  bg-[#050c12]/80">
					<BiImage className="text-xl"></BiImage>
				</div>
